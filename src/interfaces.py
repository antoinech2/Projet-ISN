...
def ShowTowerStats(game, tower):
	...
	gui = pygame.Surface(gui_size)
	gui.fill(pygame.Color("gray"))
	RenderText("Informations sur la tour: "+ str(tower.name), 20, "red", (275, 20), gui)
	RenderText("Taille: "+str(round(tower.rect.width/game.box_size_pixel[0],2))+" x "+str(round(tower.rect.height/game.box_size_pixel[1],2)), 15, "black", (150, 40), gui)
	RenderText("Dégâts: "+str(tower.attack_damage)+"±"+str(tower.random_attack_damage_range), 15, "black", (150, 60), gui)
	RenderText("Délai d'attaque: "+str(tower.attack_cooldown)+"±"+str(tower.random_attack_cooldown_range)+" sec.", 15, "black", (150, 80), gui)
	RenderText("Attaques simultanées: "+str(tower.attack_enemies)+"±"+str(tower.random_attack_enemies_range), 15, "black", (150, 100), gui)
	...
	RenderText("Tirs totaux: "+str(tower.total_shoot), 15, "black", (650, 60), gui)
	RenderText("Dêgats infligés: "+str(round(tower.total_damage,1)), 15, "black", (650, 80), gui)
	RenderText("Ennemis éliminés: "+str(tower.total_kill), 15, "black", (650, 100), gui)
	return gui
